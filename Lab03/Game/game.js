...
class Bird {
  ...
  constructor() {
    ...
    this.images[0].src = "assets/Flappy Bird/yellowbird-downflap.png";
    this.images[1].src = "assets/Flappy Bird/yellowbird-midflap.png";
    this.images[2].src = "assets/Flappy Bird/yellowbird-upflap.png";
    this.velocity = 0;
    this.alive = true;
  }
  draw() {
    if (this.images[this.currentImage].complete) {
      const middleX =
        this.position.x + this.images[this.currentImage].width / 2;
      const middleY =
        this.position.y + this.images[this.currentImage].height / 2;
      ctx.save();
      ...
      ctx.drawImage(
        ...
        -this.images[this.currentImage].width / 2,
        -this.images[this.currentImage].height / 2,
        this.images[this.currentImage].width,
        this.images[this.currentImage].height
      );

      ctx.restore();
      if (this.animationCounter++ > 12 && this.alive) {
